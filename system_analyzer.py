...
with columns[1]:
    with st.container():
        ...
        fig= px.bar(data_frame=tem_fun_time, x=tem_fun_time["method"], y="time", color=tem_fun_time["server_function"],barmode = 'group', width=450) #  width=500
...
df = sys_processor_obj.create_df_from_prof_files(path, selected_files)  #D:\iasys\practice\poc_system_dashboard\profiles\GET.root.1ms.1697973785.prof
